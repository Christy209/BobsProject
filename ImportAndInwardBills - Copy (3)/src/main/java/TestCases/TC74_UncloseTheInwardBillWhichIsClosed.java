...
public class TC74_UncloseTheInwardBillWhichIsClosed {
	public WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/MIIB.xlsx";
    private static final String SHEET_NAME = "TC74";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC74_UncloseTheInwardBillWhichIsClosed");
        String labelText=null;
        String VlabelText=null;
        Login1 login = new Login1();

        try {
        	RowData id = ExcelUtils.getRowAsRowData("TC73", 1);
