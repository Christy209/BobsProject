...
public class TC66_lodgeTheBillInwardBillForAccept {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC66_lodgeTheBillInwardBillForAccept");
