...
import CASA.CreateCashCreditAccount;
import CASA.VerificationOfCashCreditAccount;
...
public class TC05_CreatingCashCreditAccountAndVerification {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC05_CreatingCashCreditAccountAndVerification");
        ...
        try {
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               CreateCashCreditAccount saving = new CreateCashCreditAccount(driver);
            ...
            VerificationOfCashCreditAccount verifier = new VerificationOfCashCreditAccount(driver);
