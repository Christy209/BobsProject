...
public class TC62_CloseTheCreatedCurrentAccount {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC62_CloseTheCreatedCurrentAccount");
        ...
        try {
        	  RowData cl = ExcelUtils.getRowAsRowData("TC56", 1);
