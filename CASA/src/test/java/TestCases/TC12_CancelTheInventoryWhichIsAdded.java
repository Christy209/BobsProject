...
public class TC12_CancelTheInventoryWhichIsAdded {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC12_CancelTheInventoryWhichIsAdded");
