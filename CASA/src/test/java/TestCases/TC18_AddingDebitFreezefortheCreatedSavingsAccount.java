...
import CASA.AddTotalFreezeToTheCreatedSavingsAccount;
...
public class TC18_AddingDebitFreezefortheCreatedSavingsAccount {

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC18";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC18_AddingDebitFreezefortheCreatedSavingsAccount");
        ...
        try {
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               AddTotalFreezeToTheCreatedSavingsAccount saving = new AddTotalFreezeToTheCreatedSavingsAccount(driver);
               Map<String, String> result = saving.execute(id,open,SHEET_NAME, 1, EXCEL_PATH);
            ...
            AddTotalFreezeToTheCreatedSavingsAccount verifier = new AddTotalFreezeToTheCreatedSavingsAccount(driver);
            Map<String, String> verifyResult = verifier.execute(tranId,open, SHEET_NAME, 2, EXCEL_PATH);
