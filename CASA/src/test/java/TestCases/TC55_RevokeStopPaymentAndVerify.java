...
import CASA.VerificationOfStopPayment;
...
public class TC55_RevokeStopPaymentAndVerify {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC55_RevokeStopPaymentAndVerify");
        ...
        try {
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               Map<String, String> result = saving.execute(id,open,cl,SHEET_NAME, 1, EXCEL_PATH);
            ...
            VerificationOfStopPayment verifier = new VerificationOfStopPayment(driver);
            Map<String, String> verifyResult = verifier.execute(tranId,open,cl, SHEET_NAME, 2, EXCEL_PATH);
