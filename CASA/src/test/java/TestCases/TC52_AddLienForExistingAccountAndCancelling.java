...
public class TC52_AddLienForExistingAccountAndCancelling {

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC52";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC52_AddLienForExistingAccountAndCancelling");
        ...
        try {
        	 ...
        	 RowData vl = ExcelUtils.getRowAsRowData(SHEET_NAME, 2);
        	 
            
               login.First();           
               WindowHandle.validateAlreadyLoggedIn(driver, logFile);           
               Lien saving = new Lien(driver);
               Map<String, String> result = saving.execute(cl,id,id,id,SHEET_NAME, 1, EXCEL_PATH);
               ...
               login.Second();           
               WindowHandle.validateAlreadyLoggedIn(driver, logFile);           
               Lien verify = new Lien(driver);
               Map<String, String> verifyresult = verify.execute(vl,id,vl,id,SHEET_NAME,2, EXCEL_PATH);
