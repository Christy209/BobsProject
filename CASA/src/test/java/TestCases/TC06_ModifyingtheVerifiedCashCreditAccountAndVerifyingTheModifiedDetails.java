...
import CASA.ModifyCashCreditAccountAfterVerification;
import CASA.VerificationOfCashCreditAfterModification;
...
public class TC06_ModifyingtheVerifiedCashCreditAccountAndVerifyingTheModifiedDetails {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC06_ModifyingtheVerifiedCashCreditAccountAndVerifyingTheModifiedDetails");
        ...
        try {
        	...
        	RowData open = ExcelUtils.getRowAsRowData("TC05",1);
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               ModifyCashCreditAccountAfterVerification saving = new ModifyCashCreditAccountAfterVerification(driver);
               Map<String, String> result = saving.execute(id,open,open,SHEET_NAME, 1, EXCEL_PATH);
            ...
            VerificationOfCashCreditAfterModification verifier = new VerificationOfCashCreditAfterModification(driver);
            Map<String, String> verifyResult = verifier.execute(tranId,id,id, SHEET_NAME, 2, EXCEL_PATH);
