...
import CASA.OpeningSavingsAccount;
...
public class TC01_CreateSavingsAccountWith5000AmtVerify {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC01_CreateSavingsAccountWith5000AmtVerify");
        ...
        try {
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               OpeningSavingsAccount saving = new OpeningSavingsAccount(driver);
            ...
            VerificationOfSavingsAccount verifier = new VerificationOfSavingsAccount(driver);
