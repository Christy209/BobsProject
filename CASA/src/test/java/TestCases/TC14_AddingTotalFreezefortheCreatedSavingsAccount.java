...
public class TC14_AddingTotalFreezefortheCreatedSavingsAccount {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC14_AddingTotalFreezefortheCreatedSavingsAccount");
