...
public class TC41_DoCashdepositforExistingCurrentUsingCashCrossCCYReceipt {

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC41";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC41_DoCashdepositforExistingCurrentUsingCashCrossCCYReceipt");
        ...
        try {
            ...
            RowData id = ExcelUtils.getRowAsRowData("TC41", 1);
