...
public class TC31_InquireThePostedTransactionAsCrossCCYPaymentImplicit {
    public WebDriver driver;
	private WebDriverWait wait;
	
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC31";
    ...
    public void runTest() throws Exception {
        ...
        String logFile = TestResultLogger
                .createLogFile("TC31_InquireThePostedTransactionAsCrossCCYPaymentImplicit");
        ...
        while (attempt <= maxRetry && !testPassed) {
            ...
            try {
                ...
                RowData id = ExcelUtils.getRowAsRowData("TC30", 1);
                ...
                // ---------------- POST ----------------//
                Map<String, String> verifyResult =tran.executeWithResultMap(post, id,"TC31", 1, EXCEL_PATH);
