...
import CASA.VerificationOfIssuedCheckbook;
...
public class TC07_IssuingCheckbookFortheCreatedSavingsAccountAndVerifying {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC07_IssuingCheckbookFortheCreatedSavingsAccountAndVerifying");
        ...
        try {
            ...
            VerificationOfIssuedCheckbook verifier = new VerificationOfIssuedCheckbook(driver);
