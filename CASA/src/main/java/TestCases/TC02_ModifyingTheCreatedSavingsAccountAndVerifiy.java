...
import CASA.ModificationOfSavingsAccountVerification;
import CASA.VerifyingTheSavingsAccountAfterModification;
...
public class TC02_ModifyingTheCreatedSavingsAccountAndVerifiy {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC02_ModifyingTheCreatedSavingsAccountAndVerifiy");
        ...
        try {
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               ModificationOfSavingsAccountVerification saving = new ModificationOfSavingsAccountVerification(driver);
            ...
            VerifyingTheSavingsAccountAfterModification verifier = new VerifyingTheSavingsAccountAfterModification(driver);
