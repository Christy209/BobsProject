...
public class TC54_StopPaymentAndVerifyTheStopPayment {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC54_StopPaymentAndVerifyTheStopPayment");
        ...
        try {
            ...
            Map<String, String> verifyResult = verifier.execute(tranId,open,id, SHEET_NAME, 2, EXCEL_PATH);
