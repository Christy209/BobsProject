...
public class TC23_InquireTheTransactionAsCashNormalPayment {
    public WebDriver driver;
	private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC23";
    ...
    public void runTest() throws Exception {
        ...
        String logFile = TestResultLogger
                .createLogFile("TC23_InquireTheTransactionAsCashNormalPayment");
        ...
        while (attempt <= maxRetry && !testPassed) {
            ...
            try {
                ...
                RowData id = ExcelUtils.getRowAsRowData("TC22", 1);
                ...
                // ---------------- POST ----------------//
                Map<String, String> verifyResult =tran.executeWithResultMap(post, id,"TC08", 1, EXCEL_PATH);
