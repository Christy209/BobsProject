...
import CASA.CreatingCurrentAccount;
import CASA.VerificationOfCurrentAccount;
...
public class TC56_CreatingCurrentAccountAndVerificationOfCurrent {

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC56";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC56_CreatingCurrentAccountAndVerificationOfCurrent");
        ...
        try {
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               CreatingCurrentAccount saving = new CreatingCurrentAccount(driver);
            ...
            VerificationOfCurrentAccount verifier = new VerificationOfCurrentAccount(driver);
