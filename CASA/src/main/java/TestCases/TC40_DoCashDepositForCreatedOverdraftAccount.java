...
public class TC40_DoCashDepositForCreatedOverdraftAccount{

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/HCASHDEP.xlsx";
    private static final String SHEET_NAME = "TC40";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC40_DoCashDepositForCreatedOverdraftAccount");
        ...
        try {
        	 RowData tranid = ExcelUtils.getRowAsRowData(SHEET_NAME, 1);
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               Map<String, String> result = saving.execute(tranid,id,id,SHEET_NAME, 1, EXCEL_PATH);
