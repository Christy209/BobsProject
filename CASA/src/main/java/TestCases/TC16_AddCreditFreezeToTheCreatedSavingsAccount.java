...
public class TC16_AddCreditFreezeToTheCreatedSavingsAccount {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC16_AddCreditFreezeToTheCreatedSavingsAccount");
