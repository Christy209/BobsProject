...
import CASA.ModifyingtheCreatedCurrentAccount;
import CASA.VerificationOfModifiedCurrentAccount;
...
public class TC57_ModifyingTheCreatedCurrentAccountAndVerifying {

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC57";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC57_ModifyingTheCreatedCurrentAccountAndVerifying");
        ...
        try {
        	...
        	RowData open = ExcelUtils.getRowAsRowData("TC56",1);
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               ModifyingtheCreatedCurrentAccount saving = new ModifyingtheCreatedCurrentAccount(driver);
            ...
            VerificationOfModifiedCurrentAccount verifier = new VerificationOfModifiedCurrentAccount(driver);
