...
public class TC50_ModifytheLienWhichIsAdded {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC50_ModifytheLienWhichIsAdded");
        ...
        try {
        	RowData id = ExcelUtils.getRowAsRowData("TC01", 1);
        	 ...
        	 RowData vl = ExcelUtils.getRowAsRowData(SHEET_NAME, 2);
               ...
               Map<String, String> verifyresult = verify.execute(vl,id,vl,cl,SHEET_NAME,2, EXCEL_PATH);
