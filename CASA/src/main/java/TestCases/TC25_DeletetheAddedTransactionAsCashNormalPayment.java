...
public class TC25_DeletetheAddedTransactionAsCashNormalPayment {
	public WebDriver driver;
	private WebDriverWait wait;
	
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/HTM.xlsx";
    private static final String SHEET_NAME = "TC25";
    ...
    public void runTest() throws Exception {
        ...
        String logFile = TestResultLogger
                .createLogFile("TC25_DeletetheAddedTransactionAsCashNormalPayment");
        ...
        while (attempt <= maxRetry && !testPassed) {
            ...
            try {
                ...
                RowData verify = ExcelUtils.getRowAsRowData(SHEET_NAME, 2);
                ...
                Map<String, String> result =
                        tran.execute(id, id, id, SHEET_NAME, 1, EXCEL_PATH);
                ...
                Map<String, String> verifyresult =
                        tran.execute(verify, id, id,
                                SHEET_NAME, 2, EXCEL_PATH);

                if (verifyresult.containsKey("errorMsg")) {
                    throw new RuntimeException(verifyresult.get("errorMsg"));
                }

                VlabelText = verifyresult.get("TransactionMessage");
                TestResultLogger.log(logFile, VlabelText);

                testPassed = true;   // ✅ VERY IMPORTANT
            } catch (AssertionError ae) {

                    if (labelText == null || labelText.trim().isEmpty()||VlabelText == null || VlabelText.trim().isEmpty()) {
