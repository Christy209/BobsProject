...
public class TC34_PostTheTransactionAsCrossCCyReceiptImplicitAndVerifying {
	public WebDriver driver;
	private WebDriverWait wait;
	
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC34";
    ...
    public void runTest() throws Exception {
        ...
        String logFile = TestResultLogger
                .createLogFile("TC34_PostTheTransactionAsCrossCCyReceiptImplicitAndVerifying");
        ...
        while (attempt <= maxRetry && !testPassed) {
            ...
            try {
                ...
                RowData id = ExcelUtils.getRowAsRowData("TC33", 1);
                ...
                Map<String, String> result =
                        tran.execute(post, id, id, SHEET_NAME, 1, EXCEL_PATH);
