...
import CASA.AddInventoryMovement;
...
public class TC09_AddingInventoryMomentBetweenLocations {

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC09";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC09_AddingInventoryMomentBetweenLocations");
        ...
        try {
            ...
            // ---------------- Step 1: Login & Create Savings Account ----------------//
               ...
               AddInventoryMovement saving = new AddInventoryMovement(driver);
           ...
           LogOut.performLogout(driver, wait);           
            ...
            AddInventoryMovement verifier = new AddInventoryMovement(driver);
