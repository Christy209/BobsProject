...
public class TC60_ClosetheCreatedODAccount {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC60_ClosetheCreatedODAccount");
        ...
        try {
        	  RowData cl = ExcelUtils.getRowAsRowData("TC03", 1);
