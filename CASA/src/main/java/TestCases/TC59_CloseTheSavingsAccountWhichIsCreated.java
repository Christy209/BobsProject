...
public class TC59_CloseTheSavingsAccountWhichIsCreated {

    private WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CASA.xlsx";
    private static final String SHEET_NAME = "TC59";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC59_CloseTheSavingsAccountWhichIsCreated");
        ...
        try {
        	  RowData cl = ExcelUtils.getRowAsRowData("TC01", 1);
