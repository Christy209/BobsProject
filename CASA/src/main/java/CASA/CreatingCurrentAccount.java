...
public class CreatingCurrentAccount  {
	...
	public CreatingCurrentAccount(WebDriver driver) {
	        this.driver = driver;
	...
	//********************************************************General tab******************************************************//
	       ...
	       try {
	                ...
	                WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("intDrAcctFlg"))),inputData.getByIndex(21));
	                WindowHandle.slowDown(1);
	                
	                WindowHandle.slowDown(1);
	                String nextIntDrCalcDt_ui = inputData.getByIndex(22);
	...
	//****************************************Scheme Details******************************************************************************************//       
	       try {
	    	    ...
	    	    String excelValue = inputData.getByIndex(23);
...
//********************************************************Nominee details******************************************************************************//	       
	     try {  
	    	 ...
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("regValue"), 8), inputData.getByIndex(24));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("cifId"), 8), inputData.getByIndex(25));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomName"), 8), inputData.getByIndex(26));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomAddrLine1"), 8), inputData.getByIndex(27));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("relation"), 8), inputData.getByIndex(28));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomStateCode"), 8), inputData.getByIndex(29));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCityCode"), 8), inputData.getByIndex(30));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCntryCode"), 8), inputData.getByIndex(31));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPcnt"), 8), inputData.getByIndex(32));
	   ...
	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPostalCode"), 8), inputData.getByIndex(33));
