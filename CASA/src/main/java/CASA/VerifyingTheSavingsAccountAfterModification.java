...
public class VerifyingTheSavingsAccountAfterModification {
	...
	public VerifyingTheSavingsAccountAfterModification(WebDriver driver) {
		   this.driver = driver;
		...
		String funcode = rowData.getByIndex(2);
	        ...
	        try {
	            ...
	            wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.id("FINW")));
			     ...
			     logWindowHandlesAndTitles();
	                ...
	                WebElement dropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("mode")));
           ...
           if (errorMsg != null && !errorMsg.trim().isEmpty()) {
	        ...
	        if("V - Verify".equalsIgnoreCase(rowData.getByIndex(2))) {
                ...
                clickSubmitAndHandlePopup(mainWindowHandle,excelPath,sheetName,i,resultMap,funcode, true);
                   return resultMap;
            }
			return resultMap;
	  }
	...
	//*************************Miscodes tab******************************************************//
			...
			retryingClick(By.id("acmoit"));
			WindowHandle.slowDown(2);
			retryingClick(By.id("acmai"));
			WindowHandle.slowDown(2);
			retryingClick(By.id("acmosd"));
	 ...
	 //-----------------------------------------------logWindowHandlesAndTitles-------------------------------------------------------//
	   ...
	   private Map<String, String> clickSubmitAndHandlePopup(String mainWindowHandle,String excelPath,String sheetName,int rowIndex,Map<String, String> result, String menu, boolean isVerify) {
		    String labelText = "";
		    ...
		    try {
		        ...
		        try {
		              ...
		              WebElement resultMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[contains(text(),'verified')]")));
			            labelText = resultMsg.getText().trim();
			            System.out.println("[INFO] Verification Result: " + labelText);
			            ...
			            if (labelText != null && !labelText.isEmpty()) {
			            	 String accountNumber = labelText.replaceAll("[^0-9]", "");
			                    ...
			                    System.out.println("✅ Extracted Account Number from Message: " + accountNumber);
