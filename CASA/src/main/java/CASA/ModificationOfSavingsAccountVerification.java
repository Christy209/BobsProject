...
public class ModificationOfSavingsAccountVerification {
	...
	public ModificationOfSavingsAccountVerification(WebDriver driver) {
        this.driver = driver;
    ...
    public Map<String, String> execute(RowData inputData,RowData id,RowData vr,String sheetname, int row, String excelPath) {
      ...
      //********************************************************Nominee details******************************************************************************//	       
	     try {  
	    	 ...
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomName"), 8), inputData.getByIndex(4));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomAddrLine1"), 8), inputData.getByIndex(5));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("relation"), 8), inputData.getByIndex(6));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomStateCode"), 8), inputData.getByIndex(7));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCityCode"), 8), inputData.getByIndex(8));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCntryCode"), 8), inputData.getByIndex(9));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPcnt"), 8), inputData.getByIndex(10));
	    	
          //------------------------------minor nominee----------------------------------------------------------------------//
          
	    	 try {

	    		  String NomineeFlag = inputData.getByIndex(11);
	    		    ...
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnName"), 8), inputData.getByIndex(12));
	    		    WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("grdnCode"))),inputData.getByIndex(13));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnAddrLine1"), 8), inputData.getByIndex(14));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnAddrLine2"), 8), inputData.getByIndex(15));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnAddrLine3"), 8), inputData.getByIndex(16));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnCityCode"), 8), inputData.getByIndex(17));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnStateCode"), 8), inputData.getByIndex(18));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnCntryCode"), 8), inputData.getByIndex(19));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnPostalCode"), 8), inputData.getByIndex(20));   
	   ...
	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPostalCode"), 8), inputData.getByIndex(21));
	    	  
    //----------------------------------------second nomineee-----------------------------------------------------------//
	    	 
          try {  
        	  WindowHandle.slowDown(1);
        	  retryingClick(By.id("nomDetail_NextRec")); 

       	     WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("cifId"), 8), inputData.getByIndex(23));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomName"), 8), inputData.getByIndex(24));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomAddrLine1"), 8), inputData.getByIndex(25));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("relation"), 8), inputData.getByIndex(26));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomStateCode"), 8), inputData.getByIndex(27));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCityCode"), 8), inputData.getByIndex(28));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCntryCode"), 8), inputData.getByIndex(29));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPcnt"), 8), inputData.getByIndex(30));
      	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPostalCode"), 8), inputData.getByIndex(31));
