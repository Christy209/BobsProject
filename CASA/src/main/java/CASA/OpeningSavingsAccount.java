...
public class OpeningSavingsAccount  {
	...
	public OpeningSavingsAccount(WebDriver driver) {
	        this.driver = driver;
	...
	//********************************************************General tab******************************************************//
	    	   ...
	    	   try {
	               ...
	               WindowHandle.selectDropdownWithJS(driver, dropdown, inputData.getByIndex(6));  
	               
	               WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("modeOfOperCode"), 8), inputData.getByIndex(7));
	               String freqOption = inputData.getByIndex(6);
	               if (freqOption != null && !freqOption.equalsIgnoreCase("N - None")) 
	               { 
	            	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("pbPsFreqType"), 8), inputData.getByIndex(8));
	                   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("pbPsFreqWeek"), 8), inputData.getByIndex(9));	            	                
	                   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("pbPsFreqDay"), 8), inputData.getByIndex(10));
	                   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("pbPsFreqStartDD"), 8), inputData.getByIndex(11));
	                   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("pbPsFreqHldyStat"), 8), inputData.getByIndex(12));
	                   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("pbPsFreqCalBase"), 8), inputData.getByIndex(13));
	                   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("despatchMode"), 8), inputData.getByIndex(14));
	            } else {
	       ...
	       try {
	                ...
	                WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("minIntPcntCr"), 8), inputData.getByIndex(15));
	                WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("maxIntPcntCr"), 8), inputData.getByIndex(16));
	                WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("custPrefIntCr"), 8), inputData.getByIndex(17));
	                WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("acctPrefIntCr"), 8), inputData.getByIndex(18));
	                WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("chanPrefIntCr"), 8), inputData.getByIndex(19));
	                WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("intCrAcctFlg"))),inputData.getByIndex(20));
	                
	                WindowHandle.slowDown(1);
	                String nextIntCrCalcDt_ui = inputData.getByIndex(21);
	                if (nextIntCrCalcDt_ui != null && !nextIntCrCalcDt_ui.trim().isEmpty()) {
	                    WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.presenceOfElementLocated(By.id("nextIntCrCalcDt_ui"))),
	                            DateUtils.toDDMMYYYY(nextIntCrCalcDt_ui));
	                }
	...
	//****************************************Scheme Details******************************************************************************************//       
	       try {
	    	    ...
	    	    String excelValue = inputData.getByIndex(22);
...
//********************************************************Nominee details******************************************************************************//	       
	     try {  
	    	 ...
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("regValue"), 8), inputData.getByIndex(23));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("cifId"), 8), inputData.getByIndex(24));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomName"), 8), inputData.getByIndex(25));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomAddrLine1"), 8), inputData.getByIndex(26));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("relation"), 8), inputData.getByIndex(27));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomStateCode"), 8), inputData.getByIndex(28));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCityCode"), 8), inputData.getByIndex(29));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCntryCode"), 8), inputData.getByIndex(30));
	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPcnt"), 8), inputData.getByIndex(31));
	    	
           //------------------------------minor nominee----------------------------------------------------------------------//
           
	    	 try {

	    		  String NomineeFlag = inputData.getByIndex(33);
	    		    ...
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnName"), 8), inputData.getByIndex(34));
	    		    WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("grdnCode"))),inputData.getByIndex(35));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnAddrLine1"), 8), inputData.getByIndex(36));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnAddrLine2"), 8), inputData.getByIndex(37));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnAddrLine3"), 8), inputData.getByIndex(38));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnCityCode"), 8), inputData.getByIndex(39));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnStateCode"), 8), inputData.getByIndex(40));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnCntryCode"), 8), inputData.getByIndex(41));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("grdnPostalCode"), 8), inputData.getByIndex(42));   
	   ...
	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPostalCode"), 8), inputData.getByIndex(32));
	    	  
     //----------------------------------------second nomineee-----------------------------------------------------------//
	    	 
           try {  
        	    String secondNomineeFlag = inputData.getByIndex(43);
        	    ...
        	    if (secondNomineeFlag != null && secondNomineeFlag.trim().equalsIgnoreCase("Y")) {
        	     ...
        	     WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("cifId"), 8), inputData.getByIndex(44));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomName"), 8), inputData.getByIndex(45));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomAddrLine1"), 8), inputData.getByIndex(46));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("relation"), 8), inputData.getByIndex(47));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomStateCode"), 8), inputData.getByIndex(48));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCityCode"), 8), inputData.getByIndex(49));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomCntryCode"), 8), inputData.getByIndex(50));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPcnt"), 8), inputData.getByIndex(51));
       	    	 WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("nomPostalCode"), 8), inputData.getByIndex(52));
	       ...
	       try {
              ...
              //-------------------------Second Relation---------------------------------------------------------------------//	    	   
	               try {
	                   ...
	                   if (inputData.getByIndex(54).equalsIgnoreCase("Y")){

	            	   retryingClick(By.xpath("//input[@id='relParty_AddNew']"));
	            	   
	            	   WindowHandle.slowDown(1);
	            	   WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("relnType"))),inputData.getByIndex(55));
	            	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("relnCode"), 8), inputData.getByIndex(56));            	   
	            	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("custTitle"), 8), inputData.getByIndex(57));
	            	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("custName"), 8), inputData.getByIndex(58));
	            	   WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("custAddrLine1"), 8), inputData.getByIndex(59));
	               } else {
...
//************************************************Document details tab*******************************************************//
	      try {
	    	  ...
	    	  WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("docCode"), 8), inputData.getByIndex(60));
	    	  WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("docScanFlg"))),inputData.getByIndex(61));
    ...
    //*************************************************FFD tab*******************************************************//
	      String ffdFlag = inputData.getByIndex(62);
	      ...
	      try {
	    	  ...
	    	  WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("schmCode"), 8), inputData.getByIndex(63));
	    	 
	    	  try {
	    		    WindowHandle.slowDown(1);
	    		    String excelValue = inputData.getByIndex(64);
	    		    ...
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("swpDepFreqMnths"), 8), inputData.getByIndex(65));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("swpDepFreqDay"), 8), inputData.getByIndex(66));
	    		    WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("swpFreqType"))),inputData.getByIndex(67));
	    		    WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("swpFreqStartDD"))),inputData.getByIndex(68));
	    		    WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("swpHldyStat"))),inputData.getByIndex(69));
	    		    WindowHandle.selectByVisibleText(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("swpFreqCalBase"))),inputData.getByIndex(70));
	    		    WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("repayInstr"), 8), inputData.getByIndex(71));	   	    	 
...
//*************************************************Account limits tab*******************************************************//
	      ...
	      try {
	    	   ...
	    	   WindowHandle.slowDown(1);       
	            String DocDate = inputData.getByIndex(72);
	            ...
	            String validFrmDate = inputData.getByIndex(73);
			    ...
			    WindowHandle.slowDown(1);	           
	            WindowHandle.selectDropdownWithJS(driver,wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("drawingPowerInd"))),inputData.getByIndex(74));
...
//********************************************Miscode Tab Details*********************************************************//	    
	    try {
	       ...
	       WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("sectCode"))),inputData.getByIndex(75));
           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("subSectCode"))),inputData.getByIndex(76));
           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("purpAdv"))),inputData.getByIndex(77));
           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("modeAdv"))),inputData.getByIndex(78));
           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("typeAdv"))),inputData.getByIndex(79));
           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("natAdv"))),inputData.getByIndex(80));
