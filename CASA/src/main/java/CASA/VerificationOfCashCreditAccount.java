...
public class VerificationOfCashCreditAccount {
...
public VerificationOfCashCreditAccount(WebDriver driver) {
        this.driver = driver;
	  ...
	  //*************************Document details tab******************************************************//
	      ...
	      //*********************************Accont Limits tab******************************************************//
			...
			retryingClick(By.id("acctlmt"));
		            ...
		            WebElement acLevelRadio = driver.findElement(
		                    By.xpath("//input[@id='limitLevelInterest' and @value='N']"));

		            WebElement limitLevelRadio = driver.findElement(
		                    By.xpath("//input[@id='limitLevelInterest' and @value='Y']"));

		            String selectedValue = "";
		            if (acLevelRadio.isSelected()) {
		                selectedValue = "A/c Level Interest";
		            } 
		            else if (limitLevelRadio.isSelected()) {
		                selectedValue = "Limit Level Interest";
		            }
		            appData.put("limitLevelInterest", selectedValue);
		            System.out.println("Selected Limit Level Interest : " + selectedValue);
	//*************************Miscodes tab******************************************************//
