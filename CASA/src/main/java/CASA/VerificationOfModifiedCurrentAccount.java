...
public class VerificationOfModifiedCurrentAccount {
	...
	public VerificationOfModifiedCurrentAccount(WebDriver driver) {
		   this.driver = driver;
	...
	//*************************Miscodes tab******************************************************//
	 ...
	 //-----------------------------------------------logWindowHandlesAndTitles-------------------------------------------------------//
	   ...
	   private Map<String, String> clickSubmitAndHandlePopup(
