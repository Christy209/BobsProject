...
public class CreatingOverdraftAccount {
	...
	public CreatingOverdraftAccount(WebDriver driver) {
	        this.driver = driver;
...
//********************************************************Nominee details******************************************************************//	       
	...
	//****************************Int Slabs************************************************************************************//
				      try {
				    	  ...
				    	  WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("tenorOfSlabInDays"), 8), inputData.getByIndex(69));
				    	  WindowHandle.setValueWithJS(driver, waitForVisibility(By.id("tenorOfSlabInMnths"), 8), inputData.getByIndex(70));
				      }catch (Exception e) {
				       	System.out.println("Int Slabs Tab Error " + e.getMessage());
				       }
	//*************************************************Account limits tab*******************************************************//
				      WindowHandle.slowDown(1);
				      try {
				    	   ...
				    	   WindowHandle.slowDown(1);       
				            String DocDate = inputData.getByIndex(71);
				            ...
				            String validFrmDate = inputData.getByIndex(72);
						    ...
						    WindowHandle.slowDown(1);	           
				            WindowHandle.selectDropdownWithJS(driver,wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("drawingPowerInd"))),inputData.getByIndex(73));
			...
			//********************************************Miscode Tab Details*********************************************************//	    
				    try {
				       ...
				       WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("sectCode"))),inputData.getByIndex(74));
			           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("subSectCode"))),inputData.getByIndex(75));
			           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("purpAdv"))),inputData.getByIndex(76));
			           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("modeAdv"))),inputData.getByIndex(77));
			           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("typeAdv"))),inputData.getByIndex(78));
			           WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("natAdv"))),inputData.getByIndex(79));
