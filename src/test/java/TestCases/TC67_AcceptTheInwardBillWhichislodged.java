...
public class TC67_AcceptTheInwardBillWhichislodged {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC67_AcceptTheInwardBillWhichislodged");
        String labelText=null;
        String VlabelText=null;
        Login1 login = new Login1();

        try {
        	  RowData id = ExcelUtils.getRowAsRowData("TC66", 1);
