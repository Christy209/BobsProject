...
public class TC65_ProtestTheInwardBillWhichIsDishonoured {
	public WebDriver driver;
    private WebDriverWait wait;
    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/MIIB.xlsx";
    private static final String SHEET_NAME = "TC65";
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC65_ProtestTheInwardBillWhichIsDishonoured");
        String labelText=null;
        String VlabelText=null;
        Login1 login = new Login1();

        try {
        	  RowData id = ExcelUtils.getRowAsRowData("TC63", 1);
