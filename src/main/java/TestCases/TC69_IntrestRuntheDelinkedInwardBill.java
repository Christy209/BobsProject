...
public class TC69_IntrestRuntheDelinkedInwardBill {
    ...
    public void runTest() throws Exception {
        String logFile = TestResultLogger.createLogFile("TC69_IntrestRuntheDelinkedInwardBill");
        String labelText=null;
        String VlabelText=null;
        Login1 login = new Login1();

        try {
        	RowData id = ExcelUtils.getRowAsRowData("TC68", 1);
